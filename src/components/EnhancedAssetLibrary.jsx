          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
              {loading ? <div className="flex items-center justify-center h-64">
                  ...
                  {filteredAssets.map(asset => <div key={asset._id} className="group cursor-pointer border rounded-lg overflow-hidden hover:shadow-lg transition-all hover:border-purple-300" onClick={() => {
                onAssetSelect(asset);
              }}>
