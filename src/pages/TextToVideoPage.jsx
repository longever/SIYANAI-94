      ...
      <Card className="border-0 shadow-lg">
        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <Textarea id="text-description" placeholder="请输入您想要生成的视频内容描述，越详细越好..." value={prompt} onChange={handleTextChange} className="min-h-[120px] resize-none" />
          ...
          <Button onClick={handleGenerateVideo} disabled={isGenerating || !prompt.trim() || useAudio && !audioFile} className="w-full" size="lg">
            {isGenerating ? <>
